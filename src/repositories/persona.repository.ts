...
> {
  ...
  constructor(
    @inject('datasources.pedidosDB') dataSource: PedidosDbDataSource, @repository.getter('PedidoRepository') protected pedidoRepositoryGetter: Getter<PedidoRepository>,
  ) {
